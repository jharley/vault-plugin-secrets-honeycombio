module github.com/jharley/vault-plugin-secrets-honeycombio
...
replace github.com/hashicorp/go-secure-stdlib/plugincontainer v0.4.2 => github.com/hashicorp/go-secure-stdlib/plugincontainer v0.5.0
